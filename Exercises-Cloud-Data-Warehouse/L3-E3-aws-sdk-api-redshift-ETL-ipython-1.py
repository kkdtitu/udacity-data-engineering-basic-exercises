...
try:
    ...
    print("Redshift cluster properties during cluster creation:\n", myClusterProps)
...
#Now create table in Redshift

get_ipython().run_cell_magic('sql', '', 'DROP TABLE IF EXISTS sporting_event_ticket')

#get_ipython().run_cell_magic('sql', 'CREATE TABLE IF NOT EXISTS sporting_event_ticket', '(\ncol1 INT PRIMARY KEY, \
#                               \n col2 INT);')
get_ipython().run_cell_magic('sql', 'CREATE TABLE IF NOT EXISTS sporting_event_ticket', '(col1 INT PRIMARY KEY, \
                               col2 INT);')
get_ipython().run_cell_magic('sql', '', 'INSERT INTO sporting_event_ticket VALUES (100, 101)')
get_ipython().run_cell_magic('sql', '', 'INSERT INTO sporting_event_ticket VALUES (102, 103)')
get_ipython().run_cell_magic('sql', '', 'INSERT INTO sporting_event_ticket VALUES (104, 105)')

result = get_ipython().run_cell_magic('sql', '', 'SELECT * FROM sporting_event_ticket')
print(result)
for row in result:
    print (row)